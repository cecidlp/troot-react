...
function ProyectosEntregados() {
    ...
    return (
        <div className='bg-[#F5F5F5] w-full text-center md:pt-0 mx-auto px-6 -top-5 relative'>
            <h2 className='title-h2 md:text-[2.5rem] xl:text-[3.5rem]'>{isSpanish ? "+1000 proyectos entregados" : "+1000 delivered projects"}</h2>
