...
const Navbar = () => {
    ...
    return (
        <div className="bg-[#5B726C] flex justify-between items-center h-24 mx-auto px-6 w-[100%] lg:px-10">
            ...
            <ul className={nav ? "shadow-xl fixed left-0 top-0 pt-2 w-[100%] border-r rounded-b-[30px] border-none bg-[#5B726C] ease-in-out duration-500 z-20 " : "fixed top-[-100%] transition-top ease-in-out duration-500 z-20"}>
