    ...
    return (
        <div className='mx-auto px-6 py-8 lg:py-14' id="team">
            ...
            <div className='text-center flex flex-col items-center pt-11 lg:flex-row lg:justify-evenly lg:pt-16'>
                <div className='pb-7'>
                    <img src={Julieta} alt="Julieta Rocca" className='team-img w-[50vw] h-[28vh] rounded-3xl object-cover lg:w-[30vw] lg:h-[40vh]'>
                    </img>
                    ...
                    <p className='text-p md:text-[1rem] lg:text-[1.1rem] xl:text-[1.3rem]'>
                        {isSpanish ? "Traductora Pública UBA" : "Certified Translator UBA"}
                    </p>
                </div>
                <div className='lg:pb-7'>
                    <img src={Paula} alt="Paula Pace" className='team-img w-[50vw] h-[28vh] rounded-3xl object-cover lg:w-[30vw] lg:h-[40vh] '>
                    </img>
